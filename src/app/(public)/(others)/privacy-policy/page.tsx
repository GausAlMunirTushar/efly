			...
			<div className='max-w-7xl mx-auto p-5'>
				...
				<section className='mb-6'>
					...
					<p>
						...
						experience, remember your preferences, analyze usage,
						and serve targeted ads. You can manage cookie settings
				...
				<section className='mb-6'>
					...
					<p>
						...
						protect your personal information. Despite this, no
						system can be 100% secure, so we recommend safeguarding
				...
				<section className='mb-6'>
					...
					<p>
						...
						as needed to provide services and comply with legal
						obligations. Once data is no longer required, we
				...
				<section className='mb-6'>
					...
					<p>
						...
						changes will be reflected on this page, and we will
