			...
			<div className='max-w-7xl mx-auto p-6'>
				...
				<section className='mb-6'>
					...
					<p>
						...
						your login credentials. You agree to provide accurate
						and complete information and to update it when
						necessary.
					</p>
				</section>
				...
				<section className='mb-6'>
					...
					<p>
						...
						fraudulent booking, abuse of promotions, or attempts to
						hack the system may lead to suspension or permanent
				...
				<section className='mb-6'>
					...
					<p>
						...
						time. Continued use of our services after changes are
